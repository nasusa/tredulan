...
<div class="aboutmiddle">
  ...
  <h2 class="abouth2">MUUT JÄRJESTÄJÄT</h2> <p class="aboutp"> -TULOSSA- </p>
  <!--<p class="aboutp">Jotta tapahtumamme on turvallinen, mukana ovat koivistonkylän järjestyksenvalvoja opiskelijat. Tämän lisäksi Mediapolikselta tulee opiskelijoita kuvaamaan ja videoimaan tapahtumaa. </p> <p class="infop">Hepolamminkadun toimipisteeltä tulee kaksi opettajaa valvomaan sekä catering-puolelta tullaan järjestämään kahvio sähkötalolle tapahtuman ajaksi.  </p> --> </br>
</div>
<div class="social">
    <p class="aboutp"><i class="fa fa-envelope-o" aria-hidden="true"> tredulan@gmail.com</i></p>
</div>
